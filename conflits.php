...
<script>
    ...
    function initialize() {
        ...
        <?php    // Ajout des zones dangereuses
            ...
            WHERE z.coordonnees_id = c.coordonnees_id AND tz.type_zone_id = z.type_zone_id AND tz.type_zone_libelle = 'guerre'");
            $select->setFetchMode(PDO::FETCH_OBJ);
            while($e = $select->fetch()) { ?>
	...
	<div id="wrap">
		...
		<div id="gauche">
			...
			<div id="event"><span class="entypo-bell"></span>- nom conflit -</div>
